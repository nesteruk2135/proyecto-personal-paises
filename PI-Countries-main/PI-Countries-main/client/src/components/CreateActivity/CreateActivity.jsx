...
import { getActivities, getAllCountries, postActivity } from "../../Redux/Actions";
import LoadingCreate from "./LoadingCreate/Loading";
import "./CreateActivity.css"
import background from "../img/activity.jpg"
...
export default function CreateActivity() {
    ...
    function handleSubmit(e) {
        ...
        if (Object.values(errors).length === 0) {
            ...
            alert("Please complete alla the entries before creating an activity")
            ...
            {loading === true ? (
                ...
                <div className='create-container'>
                    ...
                    <form className="create-form" onSubmit={(e) => handleSubmit(e)}>
                        ...
                        <select className='select-form' name='difficulty'
                            onChange={handleChange}>
